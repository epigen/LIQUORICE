...
# This code is from here: https://github.com/deeptools/deepTools/blob/8ffaee5ab09d3659afaef64d83cec6a305e115b7/deeptools/countReadsPerBin.py
...
class CountReadsPerBin(object):
    ...
    def is_proper_pair(read, maxPairedFragmentLength):
        ...
        True
        """
        # if not read.is_proper_pair: # NOTE These two lines have been deactivated for LIQUORICE
        #     return False
        if read.reference_id != read.next_reference_id:
            return False
